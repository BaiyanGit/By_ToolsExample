...
ByFramework 默认面向中文开发团队。文档语言、Editor UI、Console 日志、验证报告和新增 Runtime 日志均默认中文优先。

## Editor UI Language Convention
...
Runtime 面向开发者的日志采用“中文说明 + 英文对象名”，例如：
...
不要为了中文而强行翻译稳定技术对象名。后续新增 Editor 工具默认采用中文 UI，新增 Runtime 日志默认采用中文提示，目标用户主要为国内开发人员、实施人员和测试人员。
