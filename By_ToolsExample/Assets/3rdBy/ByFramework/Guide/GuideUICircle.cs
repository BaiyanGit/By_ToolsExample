namespace _3rdBy.ByFramework.Guide
{
    ...
    /// 圆形遮罩镂空引导
    /// </summary>
    public class GuideUICircle : UIGuideBase
    {
        /// <summary>
        /// 区域范围缓存
        /// </summary>
        ...
        private void OnEnable()
        {
            ...
            //计算最终高亮显示区域的半径
            _radius = Vector2.Distance(WorldToCanvasPos(CurrentCanvas, _corners[0]),
                WorldToCanvasPos(CurrentCanvas, _corners[2])) / 2f;
            //计算高亮显示区域的圆心
            ...
            //计算当前高亮显示区域的半径
            RectTransform canRectTransform = CurrentCanvas.transform as RectTransform;
            if (canRectTransform != null)
            {
                ...
                {
                    _currentRadius = Mathf.Max(Vector3.Distance(WorldToCanvasPos(CurrentCanvas, corner), center),
                        _currentRadius);
                }
            }
