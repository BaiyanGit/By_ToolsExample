namespace _3rdBy.ByTools.ExcelDataTool.Editor.ExcelConvet
{
    using System.IO;
    using UnityEngine;
    ...
    public static class ExcelConvertPathSetting
    {
        ...
        /// 插件路径
        /// </summary>
        public const string PluginPath = "Assets/3rdBy/UniTools/ExcelDataTool/";

        /// <summary>
        /// 模板路径
        /// </summary>
        public const string ExcelTemplateFilePath =
            PluginPath + "Editor/ExcelConvet/Template/ExcelDataClassTemplate.txt";
        ...
        public static string GetExcelGenerateAssetFilePath(ExcelConvertPathType pathType)
        {
            ...
            {
                ExcelConvertPathType.Resources => Application.dataPath + ASSET_OUTPUT_PATH,
