...
namespace _3rdBy.UniTools.XmlDataTool.Editor.Generator
{
    ...
    public class JsonToClassGeneratorBy
    {
        ...
        public void GenerateClassesFromJson(string json, string className)
        {
            ...
            var rootTemplate = XmlConvertPathSetting.GetClassTemplateContent("XmlDataClassTemplate");
        ...
        {
            var folder = Path.Combine(Application.dataPath, "Scripts/XmlData/");
            if (!Directory.Exists(folder)) Directory.CreateDirectory(folder);
            var filePath = $"{folder}{fileName}.cs";
