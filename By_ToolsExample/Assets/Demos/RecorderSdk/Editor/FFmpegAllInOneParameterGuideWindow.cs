...
public sealed class FFmpegParameterGuideContent
{
    private const string WINDOW_TITLE = "FFmpeg 参数大词典";
    ...
    private void DrawSearchToolbar()
    {
        ...
        GUILayout.Space(8);
        bool nextOnlyRecorderRelated = GUILayout.Toggle(_onlyRecorderRelated, "只看录屏相关", EditorStyles.toolbarButton, GUILayout.Width(104), GUILayout.Height(22));
        if (nextOnlyRecorderRelated != _onlyRecorderRelated)
        {
            _onlyRecorderRelated = nextOnlyRecorderRelated;
            _filterCacheDirty = true;
        }
