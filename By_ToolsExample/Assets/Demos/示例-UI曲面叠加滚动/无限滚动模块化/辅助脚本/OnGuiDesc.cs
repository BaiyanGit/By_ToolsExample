namespace Demos.示例_UI曲面叠加滚动.Scripts
{
    ...
    public class OnGuiDesc : MonoBehaviour
    {
        ...
        private const string Desc = "<b><color=red><size=30> UI曲面叠加滚动 </size></color></b>\n\n" +
                                    "未使用UGUI控件ScrollRect实现的UI曲面叠加滚动效果。\n\n" +
                                    "支持：\n" + "无限循环滚动、曲面滚动、曲面缩放、曲面颜色变化。\n\n" +
                                    "操作：\n" +
                                    "鼠标滚轮滚动、左右箭头键切换曲面、拖拽滚动、点击Item滚动居中。\n\n" +
                                    "【曲面UI滚动】 ：需要在Image、RawImage、Text等组件上挂载 <color=green>ByCurvedUI</color> 材质，并设置曲面参数。\n";
