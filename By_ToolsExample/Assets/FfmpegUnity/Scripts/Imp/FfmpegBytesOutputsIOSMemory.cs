...
{
    public class FfmpegBytesOutputsIOSMemory : FfmpegBytesOutputs
    {
        ...
        public FfmpegBytesOutputsIOSMemory(string[] outputOptions, FfmpegCommand command) : base(outputOptions, command)
        {
        }
