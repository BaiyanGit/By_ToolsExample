...
namespace FfmpegUnity
{
    public class FfmpegCommandImpWinLib : FfmpegCommandImpBase
    {
        ...
        static extern void ffmpeg_start(int argc, IntPtr argv, int id, string file_path);
        [DllImport("libffmpegDll")]
        ...
        public override IEnumerator StartFfmpegCoroutine(string options)
        {
            ...
            ffmpegThread_ = new Thread(() =>
            {
                ...
                isRunning_ = true;
                ffmpeg_start(splitedOptions.Length, splitedOptionsPtr, currentId_, logFilePath_);
                isStop_ = true;
