...
#if UNITY_EDITOR_WIN || (UNITY_EDITOR_OSX && FFMPEG_UNITY_USE_BINARY_MAC) || UNITY_EDITOR_LINUX
...
#if ((UNITY_STANDALONE_OSX && FFMPEG_UNITY_USE_BINARY_MAC) || UNITY_STANDALONE_LINUX) && ENABLE_IL2CPP
...
#elif UNITY_EDITOR_WIN || (UNITY_EDITOR_OSX && FFMPEG_UNITY_USE_BINARY_MAC) || UNITY_EDITOR_LINUX || ((UNITY_STANDALONE_WIN || (UNITY_STANDALONE_OSX && FFMPEG_UNITY_USE_BINARY_MAC) || UNITY_STANDALONE_LINUX) && !ENABLE_IL2CPP)
...
#elif (UNITY_STANDALONE_OSX && FFMPEG_UNITY_USE_BINARY_MAC) || UNITY_STANDALONE_LINUX
...
#elif ((UNITY_STANDALONE_OSX && FFMPEG_UNITY_USE_BINARY_MAC) || UNITY_STANDALONE_LINUX) && ENABLE_IL2CPP
            string fileName = "ffmpeg";
#if !(UNITY_STANDALONE_OSX && FFMPEG_UNITY_USE_BINARY_MAC && !FFMPEG_UNITY_USE_OUTER_MAC || UNITY_STANDALONE_LINUX && !FFMPEG_UNITY_USE_OUTER_LINUX)
            fileName = Application.streamingAssetsPath + "/_FfmpegUnity_temp/ffmpeg";
#endif
